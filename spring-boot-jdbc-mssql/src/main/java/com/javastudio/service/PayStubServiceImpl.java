...
public class PayStubServiceImpl implements PayStubService {
    ...
    public List<String> findIssueYears(Optional<Long> employeeId) {
        ...
        String query = "select distinct (pc.IssueYearMonth/100) IssueYear from HCM3.PayCalc pc where pc.EmployeeRef = ? and IssueYearMonth >= 139000 order by (pc.IssueYearMonth/100);";
